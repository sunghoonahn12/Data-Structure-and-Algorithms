...
public:
  ...
  // Delete whole subtree with recursive function
  void deleteTree(Node* n);
  // Recursively iterate through list for print
  void printRecursive(Node* n) const;
  // Find depth by recursion
  int curDepth(Node* n) const;
